...
export default function ManageExpense({ route, navigation }) {
  ...
  async function deleteExpenseHandler() {
    ...
    await deleteExpense(editedExpenseId); // navigation.goBack is executed ONLY AFTER the deletion in Firebase is succeded.
  ...
  async function confirmHandler(expenseData) {
    if (isEditing) {
      // update expense (locally first in context)
      expensesCtx.updateExpense(editedExpenseId, expenseData);
      await updateExpense(editedExpenseId, expenseData); // navigation.goBack is executed ONLY AFTER the update in Firebase is succeded.
    } else {
      // add expense
